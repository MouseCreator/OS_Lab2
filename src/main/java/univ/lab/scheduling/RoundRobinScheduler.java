...
public class RoundRobinScheduler {
    private final List<ScheduledProcess> activeProcessList;
    ...
    public void addProcess(ScheduledProcess process) {
        this.activeProcessList.add(process);
    }
